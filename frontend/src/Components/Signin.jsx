...
if(!resp){
 ...
 setLoading(true)
    fetch(`https://tame-ox-train.cyclic.app/user/login`,{
      method:"POST",
      headers:{
...
<div className="text" data-text="Signing In"></div>
  ...
  return (
    ...
    <div className="loginForm2" style={{color:"blue"}}>
      Dont Have an account ? <Link to="/signup"><span style={{color:"tomato",cursor:"pointer",fontWeight:"bolder"}}>Sign Up</span></Link>
    </div>
    </div>
    </div>
  )

...
const Signup = () => {
 ...
 // checking email 
   ...
   // console.log(resp)
    ...
    fetch(`https://tame-ox-train.cyclic.app/user/signup`,{
      method:"POST",
      headers:{
  ...
  return (
    <div className='signUp'>
       ...
       <div>
       <input type="text"  name='mobile' id='mobile' placeholder='mobile' value={mobile} onChange={(e)=>setmobile(e.target.value)} />
       </div>
       <div>
       <input type="password"  name='password' id='password' placeholder='Password' value={password} onChange={(e)=>setPassword(e.target.value)} />
        ...
        <div className="form2" >
       Already Have an account ? <Link to="/signin"><span style={{color:"tomato",cursor:"pointer",fontWeight:"bolder"}}>Sign in</span></Link>
        </div>
